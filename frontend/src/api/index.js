...
export const getSectionStudents = (sec, page = 1) =>
    api.get(`/admin/sections/${sec}/students?page=${page}&limit=50`);
...
export const getNeedsAttention = () => api.get('/admin/needs-attention');
